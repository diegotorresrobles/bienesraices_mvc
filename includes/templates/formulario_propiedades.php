<fieldset>
    ...
    <?php if($propiedad->imagen): ?>
        <img src="/imagenes/<?php echo $propiedad->imagen; ?>" class="imagen-small" alt="imagen.jpg">
    <?php endif; ?>
...
<fieldset>
    ...
    <input type="number" name="propiedad[habitaciones]" id="habitaciones" placeholder="Ej. 3" min="1" max="9" value="<?php echo $propiedad->habitaciones; ?>">
